...
(function () {
  ...
  var DEFAULTS = {
    ...
    games: ["lol", "cs2"],
    flight_radius: 20,
    /* Any card added to the dashboard needs a key here and a label in
       accountModal below; merged() only copies keys it already knows, so
       older saved preferences simply fall back to "show it". */
    cards: {
      onthisday: true, sky: true, weather: true, overhead: true,
  ...
  function accountModal(){
    ...
    var cardNames = {
      onthisday:"On This Day", sky:"Sky", weather:"Weather", overhead:"Overhead",
      feeds:"Feeds", esports:"Esports", orbit:"Orbit", links:"Launchpad", notes:"Notes"
    };
